...
public class DataPersistenceManager : MonoBehaviour
{
    ...
    // File Data Handler que gestiona los flujos de informacion y la serializaci�n y deserializacion
    private FileDataHandler dataHandler;

    // Se puede acceder de manera privada y se puede modificar de manera p�blica
    ...
    public void LoadGame()
    {
        ...
        foreach (IDataPersistance dataPersistenceObj in dataPersistenceObjects)
        {
            ...
            // Cargamos seg�n su metodo de cargado
    ...
    // Si realmente deseamos guardar partida al cerrar la aplicaci�n
